...
library(NLP)
library(tm)
library(stringr) #increases capabilities to work with strings
library(wordcloud) #creates wordclouds
library(pander)
library(readxl)
library(RColorBrewer) #for color palettes used in wordclouds. 
library(DT) #for creating the transcript stats data table. 
library(sentimentr)
```
